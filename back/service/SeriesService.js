...
/**
 * Return the id of episodes marked as seen by the user
 * Return the id of episodes marked as seen by the user corresponding to the user id given in parameter
 *
